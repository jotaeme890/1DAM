/**
 * 22 Amplía el ejercicio 13 del capítulo anterior que implementaba cuentas corrientes de un 
 * banco de tal forma que cada cuenta lleve un registro de todos
